...
describe("GeoLeaf.LayerManager", () => {
    ...
    describe("Default options", () => {
        ...
        // The title was hardcoded to « Gestionnaire de layers », franglais
        // VISIBLE on screen. It now goes through `ui.layer_manager.title`,
    ...
    // ⚠️ This block was titled `removeSection()` — a member existing on NO
    // surface and in no source. It called none of it anyway: it exercises
    // `init()` with sections. The title is corrected to what it does; the
    // test itself was valid.
    describe("init() — avec des sections déclarées", () => {
        beforeEach(() => {
            Legend.init({
                map: mockMap,
                sections: [
