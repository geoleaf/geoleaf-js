...
// Namespace : le test MUTE `lrMod.LegendRenderer.renderAccordion` pour couvrir la branche
// « renderAccordion absent ». C'est une propriété de l'objet mocké, pas la liaison du
// namespace — un namespace ESM est scellé, ses objets ne le sont pas.
