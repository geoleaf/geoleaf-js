...
// API S4.3 — `renderAccordion` consomme désormais l'import ESM comme `renderSymbol` le
// faisait déjà, et non plus `globalThis.GeoLeaf._UIComponents`. Les tests suivent : ils
// mockaient le CANAL, ils mockent maintenant le module. Un test qui plante lui-même la clé
// sur un faux global reste vert quoi qu'il arrive au vrai.
