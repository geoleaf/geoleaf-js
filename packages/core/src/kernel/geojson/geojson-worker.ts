 ...
 */
function validateWorkerUrl(url: unknown): string {
...
function _normalizeFeatures(data: unknown): unknown[] {
    const d = data as { type?: string; features?: unknown[] } | null | undefined;
 ...
 */
async function handleFetch(msg: WorkerInMessage) {
 ...
 * @param {Object} msg - Received message data
 */
async function handleFetchText(msg: WorkerInMessage) {
...
self.onmessage = function (event: MessageEvent) {
    const msg = event.data as WorkerInMessage;
