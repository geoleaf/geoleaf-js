...
<!-- GeoLeaf styles -->
<link rel="stylesheet" href="https://unpkg.com/@geoleaf/core@3.10.5/dist/geoleaf-main.min.css" />

<!-- GeoLeaf ESM (via script type="module") -->
<script type="module">
    import { Core } from "https://unpkg.com/@geoleaf/core@3.10.5/dist/geoleaf.esm.js";
...
<link
    rel="stylesheet"
    href="https://cdn.jsdelivr.net/npm/@geoleaf/core@3.10.5/dist/geoleaf-main.min.css"
/>

<!-- GeoLeaf ESM -->
<script type="module">
    import { Core } from "https://cdn.jsdelivr.net/npm/@geoleaf/core@3.10.5/dist/geoleaf.esm.js";
    // Optional — GeoJSON parsed off the main thread. A browser refuses a worker script from
    // another origin, so the CDN's copy cannot be used: serve your own copy of
    // dist/geojson-worker.js and point GeoLeaf at it before booting (see §7).
    // GeoLeaf.GeoJSON.setWorkerUrl("/assets/geoleaf/geojson-worker.js");
