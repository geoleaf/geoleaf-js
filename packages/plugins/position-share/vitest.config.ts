/**
 * Vitest configuration for @geoleaf-plugins/position-share
 *
...
export default packageConfig({
    ...
    // named `@geoleaf-plugins/position-share`, not an error. Verified on 17/08/2026.
    name: "@geoleaf-plugins/position-share",
