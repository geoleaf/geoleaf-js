/*!
 * @geoleaf-plugins/geocoding — Portuguese dictionary
 * © 2026 Mattieu Pottier — MIT License
 * https://geoleaf.dev
 */

const langGeocodingPt = {
    "geocoding.toolbar.button": "Pesquisa de endereços",
    "geocoding.control.placeholder": "Pesquisar um endereço…",
