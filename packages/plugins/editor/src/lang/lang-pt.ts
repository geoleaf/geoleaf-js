...
const lang_pt: Record<string, string> = {
    ...
    "editor.sync.detail.state.inFlight": "A enviar",
    "editor.sync.detail.state.failed": "Falhou, será repetido",
    "editor.sync.detail.state.quarantined": "Posta de parte",
    "editor.sync.detail.reason.retryBudgetExhausted": "o servidor nunca respondeu",
    "editor.sync.detail.reason.notImplementedByServer": "o servidor não conhece esta operação",
    "editor.sync.detail.reason.authRequired": "sessão expirada",
    "editor.sync.detail.reason.layerNoLongerWritable": "camada já não é editável",
    "editor.sync.detail.reason.dialectNotSupported": "modo de escrita não suportado",
    "editor.sync.detail.reason.rejectedByServer": "recusada pelo servidor",
    "editor.sync.detail.reason.deletedOnServer": "eliminada no servidor",
    "editor.sync.detail.quarantined.title": "Capturas postas de parte",
    "editor.sync.detail.requeueAll": "Repetir tudo",
    "editor.sync.detail.discard": "Descartar",
    "editor.sync.detail.discard.confirm": "Esta captura nunca será enviada.",
    "editor.sync.detail.discard.yes": "Descartar definitivamente",
    ...
    "editor.placement.duplicateTitle": "Já existe uma entidade aqui",
    "editor.placement.duplicateBody": "{title} está a {d} m do seu ponto. O que pretende fazer?",
    "editor.placement.duplicateEdit": "Editar a existente",
    "editor.placement.duplicateCreate": "Criar mesmo assim",
    "editor.placement.duplicateUnnamed": "Uma entidade",
    "editor.placement.editUnavailable": "Não foi possível abrir a entidade existente.",
