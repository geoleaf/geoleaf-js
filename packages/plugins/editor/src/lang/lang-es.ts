...
const lang_es: Record<string, string> = {
    ...
    "editor.sync.detail.state.inFlight": "Enviando",
    "editor.sync.detail.state.failed": "Fallo, se reintentará",
    "editor.sync.detail.state.quarantined": "Apartada",
    "editor.sync.detail.reason.retryBudgetExhausted": "el servidor nunca respondió",
    "editor.sync.detail.reason.notImplementedByServer": "el servidor no conoce esta operación",
    "editor.sync.detail.reason.authRequired": "sesión caducada",
    "editor.sync.detail.reason.layerNoLongerWritable": "la capa ya no es editable",
    "editor.sync.detail.reason.dialectNotSupported": "modo de escritura no admitido",
    "editor.sync.detail.reason.rejectedByServer": "rechazada por el servidor",
    "editor.sync.detail.reason.deletedOnServer": "eliminada en el servidor",
    "editor.sync.detail.quarantined.title": "Capturas apartadas",
    "editor.sync.detail.requeueAll": "Reintentar todo",
    "editor.sync.detail.discard": "Descartar",
    "editor.sync.detail.discard.confirm": "Esta captura nunca se enviará.",
    ...
    "editor.placement.duplicateTitle": "Ya existe una entidad aquí",
    "editor.placement.duplicateBody": "{title} está a {d} m de su punto. ¿Qué desea hacer?",
    "editor.placement.duplicateEdit": "Editar la existente",
    "editor.placement.duplicateCreate": "Crear de todos modos",
    "editor.placement.duplicateUnnamed": "Una entidad",
    "editor.placement.editUnavailable": "No se pudo abrir la entidad existente.",
