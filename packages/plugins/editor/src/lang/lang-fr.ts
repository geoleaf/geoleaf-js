...
const lang_fr: Record<string, string> = {
    ...
    "editor.sync.detail.state.inFlight": "En cours d'envoi",
    "editor.sync.detail.state.failed": "Échec, à retenter",
    "editor.sync.detail.state.quarantined": "Mise à l'écart",
    "editor.sync.detail.reason.retryBudgetExhausted": "le serveur n'a jamais répondu",
    "editor.sync.detail.reason.notImplementedByServer": "le serveur ne connaît pas cette opération",
    "editor.sync.detail.reason.authRequired": "session expirée",
    "editor.sync.detail.reason.layerNoLongerWritable": "couche devenue non modifiable",
    "editor.sync.detail.reason.dialectNotSupported": "mode d'écriture non pris en charge",
    "editor.sync.detail.reason.rejectedByServer": "refusée par le serveur",
    "editor.sync.detail.reason.deletedOnServer": "supprimée côté serveur",
    "editor.sync.detail.quarantined.title": "Saisies mises à l'écart",
    "editor.sync.detail.requeueAll": "Tout réessayer",
    "editor.sync.detail.discard": "Abandonner",
    "editor.sync.detail.discard.confirm": "Cette saisie ne sera jamais envoyée.",
    "editor.sync.detail.discard.yes": "Abandonner définitivement",
