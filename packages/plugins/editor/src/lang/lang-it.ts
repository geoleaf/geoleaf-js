...
const lang_it: Record<string, string> = {
    ...
    "editor.sync.detail.state.inFlight": "In invio",
    "editor.sync.detail.state.failed": "Non riuscito, sarà ritentato",
    "editor.sync.detail.state.quarantined": "Messa da parte",
    "editor.sync.detail.reason.retryBudgetExhausted": "il server non ha mai risposto",
    "editor.sync.detail.reason.notImplementedByServer": "il server non conosce questa operazione",
    "editor.sync.detail.reason.authRequired": "sessione scaduta",
    "editor.sync.detail.reason.layerNoLongerWritable": "livello non più modificabile",
    "editor.sync.detail.reason.dialectNotSupported": "modalità di scrittura non supportata",
    "editor.sync.detail.reason.rejectedByServer": "rifiutata dal server",
    "editor.sync.detail.reason.deletedOnServer": "eliminata sul server",
    "editor.sync.detail.quarantined.title": "Acquisizioni messe da parte",
    "editor.sync.detail.requeueAll": "Riprova tutto",
    "editor.sync.detail.discard": "Abbandona",
    "editor.sync.detail.discard.confirm": "Questa acquisizione non sarà mai inviata.",
    "editor.sync.detail.discard.yes": "Abbandona definitivamente",
    ...
    "editor.placement.duplicateTitle": "Qui esiste già un'entità",
    "editor.placement.duplicateBody": "{title} si trova a {d} m dal tuo punto. Cosa vuoi fare?",
    "editor.placement.duplicateEdit": "Modifica l'esistente",
    "editor.placement.duplicateCreate": "Crea comunque",
    "editor.placement.duplicateUnnamed": "Un'entità",
    "editor.placement.editUnavailable": "Impossibile aprire l'entità esistente.",
