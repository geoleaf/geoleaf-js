...
const lang_de: Record<string, string> = {
    ...
    "editor.sync.detail.state.inFlight": "Wird gesendet",
    "editor.sync.detail.state.failed": "Fehlgeschlagen, Wiederholung folgt",
    "editor.sync.detail.state.quarantined": "Zurückgestellt",
    "editor.sync.detail.reason.retryBudgetExhausted": "der Server hat nie geantwortet",
    "editor.sync.detail.reason.notImplementedByServer": "der Server kennt diesen Vorgang nicht",
    "editor.sync.detail.reason.authRequired": "Sitzung abgelaufen",
    "editor.sync.detail.reason.layerNoLongerWritable": "Ebene nicht mehr bearbeitbar",
    "editor.sync.detail.reason.dialectNotSupported": "Schreibmodus nicht unterstützt",
    "editor.sync.detail.reason.rejectedByServer": "vom Server abgelehnt",
    "editor.sync.detail.reason.deletedOnServer": "auf dem Server gelöscht",
    "editor.sync.detail.quarantined.title": "Zurückgestellte Erfassungen",
    "editor.sync.detail.requeueAll": "Alle wiederholen",
    "editor.sync.detail.discard": "Verwerfen",
    "editor.sync.detail.discard.confirm": "Diese Erfassung wird nie gesendet.",
    "editor.sync.detail.discard.yes": "Endgültig verwerfen",
