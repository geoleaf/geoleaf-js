...
const lang_en: Record<string, string> = {
    ...
    "editor.sync.detail.state.inFlight": "Sending",
    "editor.sync.detail.state.failed": "Failed, will retry",
    "editor.sync.detail.state.quarantined": "Set aside",
    "editor.sync.detail.reason.retryBudgetExhausted": "the server never answered",
    "editor.sync.detail.reason.notImplementedByServer": "the server does not know this operation",
    "editor.sync.detail.reason.authRequired": "session expired",
    "editor.sync.detail.reason.layerNoLongerWritable": "layer is no longer editable",
    "editor.sync.detail.reason.dialectNotSupported": "write mode not supported",
    "editor.sync.detail.reason.rejectedByServer": "refused by the server",
    "editor.sync.detail.reason.deletedOnServer": "deleted on the server",
    "editor.sync.detail.quarantined.title": "Captures set aside",
    "editor.sync.detail.requeueAll": "Retry all",
    "editor.sync.detail.discard": "Discard",
    "editor.sync.detail.discard.confirm": "This capture will never be sent.",
    "editor.sync.detail.discard.yes": "Discard permanently",
