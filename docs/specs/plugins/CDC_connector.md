...
> demandée avant le câblage du moteur (CN-38), vue rouge sur le bundle avant son correctif. Le **cycle de
...
| `geoleaf:connector:token-refreshed`           | Renouvellement — celui de la page, ou celui d'une instance | `{ baseUrl }`                | Relance aussi la file (CN-32) et désarme la relance (CN-35) — ⚠️ quelle que soit sa `baseUrl` |
