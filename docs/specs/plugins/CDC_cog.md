...
le contrat (PC-09) — **et `e2e/17-cog.spec.js`**, que cette ligne omettait. Le spec est le seul
...
- **Aucun accès au namespace au-delà du montage.** Le plugin écrit `GeoLeaf.COG` et
  s'enregistre ; il ne lit ni la configuration, ni l'état des couches, ni aucun seam. ⚠️ Ce montage
