...
| 13 conformes        | **Autant de plugins que le dépôt en publie** — `node scripts/verify-plugin-contract.cjs` rend le ratio. ⚠️ Cette case disait « **13** plugins » jusqu'au 11/08/2026 : ils sont **12** depuis la fusion d'`addpoi` dans `editor` |
